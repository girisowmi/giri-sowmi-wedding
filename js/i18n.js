...
var GS_STRINGS = {
  en: {
    ...
    wfJoinBlank: 'Not sure yet',
    wfJoinBoth:  'Both days',
    wfJoinRec:   'Reception only',
    wfJoinMuh:   'Muhurtham only',
    wfJoinNo:    'Sending love from afar',
    wfSend:      'Send our way',
    wfSendAnother:'Send another',
    wfSending:   'Sending&hellip;',
    wfThanks:    'Thank you &mdash; that means the world to us.',
    wfNeedName:  'Please add your name.',
    wfNeedWish:  'Please write a line for us.',
    wfFailed:    "That didn't go through. Please ",
    wfNoEndpoint:'The form is not connected yet — please ',
    wfWhatsApp:  'send it on WhatsApp',
  ...
  ta: {
    ...
    noLogin:    'வேறு எந்த சம்பிரதாயமும் வேண்டாம்.',
    stanza:     'வாழ்த்த வாருங்கள்&hellip;<br>எங்களுடன் மகிழ்ந்திருங்கள்&hellip;<br>விருந்துண்ட பின்னரே செல்லுங்கள்!',
    ...
    wfJoinBlank: 'இன்னும் உறுதியில்லை',
    wfJoinBoth:  'இரு நாட்களும்',
    wfJoinRec:   'வரவேற்பு மட்டும்',
    wfJoinMuh:   'முகூர்த்தம் மட்டும்',
    wfJoinNo:    'தூரத்திலிருந்து அன்பு',
    wfSend:      'அனுப்புங்கள்',
    wfSendAnother:'மேலும் ஒன்று அனுப்ப',
    wfSending:   'அனுப்புகிறோம்&hellip;',
    wfThanks:    'நன்றி &mdash; இது எங்களுக்குப் பெரும் மகிழ்ச்சி.',
    wfNeedName:  'உங்கள் பெயரைச் சேர்க்கவும்.',
    wfNeedWish:  'எங்களுக்கு ஒரு வரி எழுதுங்கள்.',
    wfFailed:    'அனுப்ப முடியவில்லை. ',
    wfNoEndpoint:'படிவம் இன்னும் இணைக்கப்படவில்லை — ',
    wfWhatsApp:  'WhatsApp-ல் அனுப்புங்கள்',
